...
{
    public static string BindComponentGeneratorPath = Application.dataPath + "/HotUpdate/ZMUIFrameWork/Scripts/BindCompoent";
    public static string FindComponentGeneratorPath = Application.dataPath + "/HotUpdate/ZMUIFrameWork/Scripts/FindCompoent";
    public static string WindowGeneratorPath = Application.dataPath + "/HotUpdate/ZMUIFrameWork/Scripts/Window";
