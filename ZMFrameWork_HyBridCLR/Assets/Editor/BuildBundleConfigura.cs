...
public class BuildBundleConfigura : ScriptableObject
{
    ...
    public static BuildBundleConfigura Instance
    {
        get
        {
            if (_instance==null)
            {
                Debug.Log(_instance+ "__instance");
                _instance = AssetDatabase.LoadAssetAtPath<BuildBundleConfigura>("Assets/Main/Scripts/ZMAssetsFrame/Config/BuildBundleConfigura.asset");
                Debug.Log(_instance + "__instance1");
            }
            return _instance;
        } 
    }
