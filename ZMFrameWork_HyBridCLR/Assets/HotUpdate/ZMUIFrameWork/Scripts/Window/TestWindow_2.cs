...
using ZMUIFrameWork;
	...
	public class TestWindow_2:WindowBase
	{
	
		 public TestWindow_2DataComponent dataCompt;
	
		 #region 声明周期函数
		 //调用机制与Mono Awake一致
		 public override void OnAwake()
		 {
			 dataCompt=gameObject.GetComponent<TestWindow_2DataComponent>();
