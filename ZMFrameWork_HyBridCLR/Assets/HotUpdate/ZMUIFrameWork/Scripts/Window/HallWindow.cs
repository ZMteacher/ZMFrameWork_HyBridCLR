...
public class HallWindow : WindowBase
{
    ...
    {
        ZMAsset.HotAssets(BundleModuleEnum.YZT, null, (BundleModuleEnum) =>
        {
           // Transform parent = GameObject.Find("UIRoot").GetComponent<Transform>();
           // UIModule.PopUpWindow<YZTWindow>();
          //  ZMAsset.Instantiate(AssetsPathConfig.YZT_PREFABS_PATH + "YZTWindow", parent);
            //  UIModule.PreLoadWindow<GameObject>( )
            ZMGC.Hall.HallWorld.UIModule.PopUpWindow<TestWindow_2>();
         //   ZMGC.Hall.HallWorld.UIModule.PopUpWindow<YZTWindow>();
            //PopUpWindow<YZTWindow>();
        }, null);
